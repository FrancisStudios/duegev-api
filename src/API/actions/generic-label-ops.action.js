...
const GenericLabelOps = {
    ...
    update: async () => {
        /**
         * Need session token to identify user
         * Need session token to id userPrivileges
         * Need session token to id user ownership on label
         * Need previous label ID
         * Need new label values
         */


        if (inbound.payload.session_token && inbound.payload.updatedLabel.lid) {
